  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-background px-4 py-12">
      <div className="max-w-5xl w-full mx-auto">
        ...
        <p className="font-saonara text-lg md:text-2xl text-gray-500 mb-6 leading-relaxed">
        ...
        <h2 className="font-saonara text-xl md:text-2xl font-semibold mt-8 mb-3 text-black">Why Choose Galaxies?</h2>
        <ul className="font-saonara text-lg md:text-xl text-gray-500 list-disc list-inside space-y-2 mb-8">
        ...
        <p className="font-saonara text-lg md:text-xl text-black font-semibold mb-10 leading-relaxed">
