  ...
  return (
    <div className="min-h-screen bg-background pt-8 pb-8 md:pt-16 md:pb-16">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="absolute top-[-160px] left-0 w-full z-20 flex flex-col items-center pointer-events-none">
          <div className="font-playfair text-3xl md:text-7xl lg:text-6xl font-light tracking-wide leading-tight text-center lg:absolute lg:top-0 lg:left-[5%] lg:text-left">
            A MODERN APPROACH
          </div>
          <div className="flex flex-col items-center gap-0 justify-center md:flex-row md:items-baseline md:gap-4 md:justify-center lg:absolute lg:top-[70px] lg:left-[5%] lg:justify-start">
            <span className="font-playfair text-xl md:text-3xl lg:text-4xl font-light italic mt-2 mb-0 md:mb-4">
              to an
            </span>
            <span className="font-playfair text-3xl md:text-7xl lg:text-6xl font-light tracking-wide">
              AGE OLD TRADITION
            </span>
          </div>
        </div>
        ...
        {/* Main Content Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start mb-16 mt-[180px] md:mt-[220px] lg:mt-[250px] relative">
          {/* Left Image */}
          ...
          {/* Center Text */}
          <div className="lg:col-span-1 flex flex-col justify-center px-4 sm:px-8 lg:px-2 pt-8 lg:pt-0">
          ...
          {/* Right Image */}
          <div className="lg:col-span-1 self-start relative lg:absolute lg:top-[-200px] lg:right-0 w-full lg:w-1/3 xl:w-[33.33%] z-10">
            <div className="aspect-[4/5] overflow-hidden">
              <img
        ...
        {/* Press Section */}
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-60 pt-8 pb-16 md:pb-24">
          <div className="font-playfair text-xl md:text-2xl font-bold tracking-widest">VOGUE</div>
          <div className="font-inter text-lg md:text-xl font-black tracking-wider">COSMOPOLITAN</div>
          <div className="font-inter text-lg md:text-xl font-black tracking-wider border-2 border-current px-3 py-1">HELLO!</div>
          <div className="font-playfair text-xl md:text-2xl font-bold tracking-widest">BRIDES</div>
        ...
        {/* Image Collage */}
        <div className="mb-16 w-full md:w-screen md:relative md:left-1/2 md:right-1/2 md:-ml-[50vw] md:-mr-[50vw]">
