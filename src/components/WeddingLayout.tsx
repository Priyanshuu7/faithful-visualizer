    ...
    <div className="min-h-screen bg-background pt-8 pb-8 md:pt-16 md:pb-16">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="absolute top-[-160px] left-0 w-full z-20 flex flex-col items-center pointer-events-none">
          ...
          {/* A MODERN APPROACH */}
          <div className="font-playfair text-3xl md:text-7xl lg:text-6xl font-light tracking-wide leading-tight text-center
          ...
          <div className="flex flex-row items-baseline gap-4 justify-center
            ...
            <span className="font-playfair text-xl md:text-3xl lg:text-4xl font-light italic mt-2 mb-4">to an</span>
            <span className="font-playfair text-3xl md:text-7xl lg:text-6xl font-light tracking-wide">AGE OLD TRADITION</span>
          </div>
        </div>
