...
export const Navbar = () => {
    ...
    return (
        <header
            className={` w-full z-50 ${isHomePage
            ...
            <nav className="w-full flex items-center justify-between px-6 py-4">
                ...
                <Link to="/">
                    <img
                        src={GalaxiesLogo}
                        alt="Galaxies Logo"
                        className="w-40 h-auto object-contain rounded-md brightness-110 contrast-125"/>
            ...
            {/* Mobile NavLinks */}
            <div
                className={`md:hidden w-full transition-all duration-300 ease-in-out overflow-hidden ${menuOpen
