  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-background px-4 py-12">
      <div className="max-w-5xl w-full mx-auto">
        ...
        <h2 className="font-inter text-2xl font-semibold mt-8 mb-3 text-black">Galaxies Photography and Film Productions</h2>
        <div className="space-y-8 text-gray-700 font-inter text-lg md:text-xl">
          <div>
            <h3 className="font-semibold text-black mb-2">1. Fees & Payment</h3>
          ...
          <div>
            <h3 className="font-semibold text-black mb-2">2. Cancellation & Rescheduling</h3>
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Cancellation:</strong> All deposits are non-refundable. If Galaxies Photography and Film Productions may have to cancel the photoshoot for any reason, the full deposit will be refunded. If you cancel for any reason, the deposit will be retained, regardless of notice period.</li>
              <li><strong>Rescheduling:</strong>
          ...
          <div>
            <h3 className="font-semibold text-black mb-2">3. Delivery Timeline</h3>
          ...
          <div>
            <h3 className="font-semibold text-black mb-2">4. Workflow</h3>
          ...
          <div>
            <h3 className="font-semibold text-black mb-2">5. Location Permissions & Permits</h3>
            <ul className="list-disc list-inside space-y-2">
          ...
          <div>
            <h3 className="font-semibold text-black mb-2">6. Unforeseen Situations</h3>
            <p>If a location is unexpectedly crowded, closed, or otherwise impacted by external factors (e.g., weather, construction, regulations), this will not affect the final cost of the shoot. We will adapt creatively, but such occurrences are beyond our control.</p>
          </div>
          <div>
            <h3 className="font-semibold text-black mb-2">7. Additional Services</h3>
            <p>If you request any additional service beyond the agreed package (e.g., drone shots, extra edited photos, or reels), it will incur additional charges, which will be discussed and invoiced accordingly.</p>
          </div>
          <div>
            <h3 className="font-semibold text-black mb-2">8. Data Storage</h3>
            <p>As part of our workflow, we provide clients with all RAW files for the purpose of final photo selection. Once the selection is received, we proceed with editing. After delivering the final edited images, we retain the RAW files for a few additional weeks to accommodate any requested changes. Once all edits are finalized and approved, the RAW data is permanently deleted shortly after. Final edited files are retained for up to 6 months. Clients are strongly encouraged to download and securely back up all final deliverables as soon as they are shared.</p>
          </div>
        </div>
      </div>
    </section>
