...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-background libertinus-sans-regular">
        ...
        <div className="flex flex-col items-center gap-2 md:items-start">
          <div className="flex flex-col md:flex-row items-center md:items-start space-y-2 md:space-y-0 md:space-x-6">
            <a
              ...
              className="text-sm text-zinc-700 hover:text-pink-500 transition-colors flex items-center justify-center space-x-1"
            >
              <span>Instagram</span>
            </a>
            <a
          ...
          <p className="text-sm text-zinc-700 self-center md:self-start text-center md:text-left">
            Jaipur, India
          </p>
        </div>

        {/* Contact Info */}
        <div className="flex flex-col gap-4 text-sm text-zinc-700 text-center md:text-left">
          <p>
            <span>Phone:</span>{" "}
            <a
