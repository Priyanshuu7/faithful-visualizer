...
const Footer : React.FC = () => {
    return (
        <footer className="w-full bg-background py-8">
            <div
                className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                ...
                {/* Socials + Info */}
                <div
                    className="flex flex-col items-center gap-4 text-center md:text-left md:items-start">
                ...
                {/* Contact Info */}
                <div
                    className="flex flex-col gap-2 text-sm text-zinc-700 text-center md:text-left">
                    <p>
