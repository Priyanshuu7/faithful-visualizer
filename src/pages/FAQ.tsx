...
const FAQ = () => (
  <div className="max-w-4xl mx-auto py-12 px-4 font-saonara">
    ...
    <div className="space-y-8 text-lg md:text-2xl font-saonara text-[#506270] mb-6 leading-relaxed">
      <div>
        <h2 className="font-semibold text-xl mb-1 font-saonara text-[#36454F] leading-tight">
