  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-background px-4 py-12">
      <div className="max-w-5xl w-full mx-auto">
        ...
        <p className="font-saonara text-lg md:text-2xl text-[#506270] mb-6 leading-relaxed">
        ...
        <h2 className="font-saonara text-xl md:text-2xl font-semibold mt-8 mb-3 text-[#36454F]">
          Why Choose Galaxies?
        </h2>
        <ul className="font-saonara text-lg md:text-xl text-[#506270] list-disc list-inside space-y-2 mb-8">
        ...
        <p className="font-saonara text-lg md:text-xl text-[#36454F] font-semibold mb-10 leading-relaxed">
        ...
        <div className="flex gap-8 font-inter text-base md:text-lg text-[#36454F] mt-8">
          <a href="https://www.instagram.com/galaxiesphotography" className="hover:underline font-saonara">Instagram</a>
          <a href="mailto:iamapoorv23@gmail.com" className="hover:underline font-saonara">Mail</a>
        </div>
      </div>
    </section>
  );
