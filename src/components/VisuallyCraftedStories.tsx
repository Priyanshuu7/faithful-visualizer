...
const VisuallyCraftedStories = () => {
    return (
        ...
        <h2 className="font-saonara text-xl md:text-4xl text-[#36454F] mb-4">
          "Visually Crafted Stories That Go Beyond the Frame"
        </h2>
        <p className="font-saonara text-sm md:text-base text-[#36454F]/80 max-w-2xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center">
            ...
            <span className="mt-2 text-sm font-saonara text-[#36454F]/80">Heena & Rahul</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="aspect-[4/5] overflow-hidden w-full">
              <img
            ...
            <span className="mt-2 text-sm font-saonara text-[#36454F]/80">Satvir & Bhavandeep</span>
          </div>
          <div className="flex flex-col items-center">
            <div className="aspect-[4/5] overflow-hidden w-full">
              <img
            ...
            <span className="mt-2 text-sm font-saonara text-[#36454F]/80">Jyoti & Lovejit</span>
          </div>
        </div>
      </section>
